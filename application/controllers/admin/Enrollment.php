		...
		if(!isset($_POST['action'])){
			...
			foreach($student_ids as $en){
				...
				// if($exam_form_permission[0]->exam_form_permission=='Y' && $session[0]->exam_form_permission=="Y" && $student[0]->session=='July 2024' && $student[0]->class_name=="I Year" )
				 ...
				 if($exam_form_permission[0]->exam_form_permission=='Y' && $session[0]->exam_form_permission=="Y" && $student[0]->session=='July 2025' && $student[0]->class_name=="I Year" )
				 {
...
public function getStudentData()
{
	...
	public function marksheet($exam_data_id="")
	{
		...
		if($data['exam_data']->marks_pattern == "GRADE" && in_array($new_exam_form[0]->class_id , $class_ids)){
	...
	public function search_student_marksheet(){
		...
		$this->load->view('admin/enrollment/search_student_marksheet',$data);
		$this->load->view('footer');
	}
