...
class Otherscript extends CI_Controller {
	...
	public function update_project_marks($cls_id =0)
	{
		...
		$marks = array('85','84','83','82'); 
		$cls_id=109;
		$sql = "select * from student where class_id='".$cls_id."' and new_exam_form='Y' and p_marks_sub='N' and  university_mode='PVT' and exam_pattern= 'GRADE'  and  roll_no!=0 order by roll_no  limit 1000";
