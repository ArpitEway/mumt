...
public function update_roll_no_old_data(){
	...
	public function update_pvt_grade_marks(){
		...
		$class_id=107;
		 $sql="SELECT id,student_id,paper_code,theory_marks,(theory_marks+2) as new_marks FROM `new_exam_form` WHERE class_id='".$class_id."' and theory_marks in (33,34) and sub_group_id!=1  and `student_id` in (SELECT student_id FROM `student` WHERE  `roll_number` in (210710096,210710144,210710198,210710232,210710237,210710239,210710241,210710427,210710496,210710609,210710658,210710771,210710814,210710818,210710840,210710887,210710895,210710965,210711040,210711084,210711235,210711287,210711300,210711350,210711649,210711863,210711879,210712028,210712062,210712071,210712137,210712164,210712198,210712357,210712459,210712460,210712488,210712491,210712548,210712549,210712561,210712562,213410080,213410085,213410089) and exam_form='Y' )  ";
