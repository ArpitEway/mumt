...
class Otherscript extends CI_Controller {
	...
	public function update_extra_papers_in_new_exam()
	{
		...
		foreach ($papers as $paper) {
			$where = ' class_id = "'.$paper['class_id'].'" and temp_exam_form="Y"  and university_mode="PVT"  and  exam_pattern="GRADE" and `student_id` in (784383,787712,788098,801109,801953)';
