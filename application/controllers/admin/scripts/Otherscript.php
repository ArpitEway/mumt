...
public function update_roll_no_old_data(){
	...
	$sql = "SELECT o.*,s.roll_number FROM `old_exam_data` as o join student as s on s.student_id=o.student_id WHERE `exam_year`='June 2024' and s.class_id=o.class_id and s.roll_no!=o.roll_no  limit 500";
	$students = $this->db->query($sql)->result_array();
