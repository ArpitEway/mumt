...
class Postexam extends CI_Controller {
    ...
    public function promote_student_list(){
       ...
       $this->db->from('student_june_2024 as student');
      ...
      public function promote_student($class_id="" ,$course_group_id=""){
        ...
        $this->db->limit(1000);
          $data['students']= $this->Common_model->getRecordByWhere('student',array('class_id' => $class_id, 'new_exam_form'=>'Y' , 'promote'=>'N' ,'course_complete'=>'N' ));
      ...
      public function promote_student_submit(){
        foreach($_POST['student_id'] as $student_id){
           // $student= $this->Common_model->getRecordByWhere('student',array('student_id'=>$student_id));
            ...
            $update_result =$this->Common_model->updateRecordByConditions('student_june_2024',$where,$data_result);
        }
        if($update){
