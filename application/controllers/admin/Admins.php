...
public function update_exam_datewise_permission(){
	...
	public function backlog_tr_class_list(){
		$where = "id in (select distinct(course_group_id) from backlog_student where exam_form = 'Y' and exam_year='June 2024' and class_id in (101,104,105,108,110,119,125,126,128,131,137,154,155,168,175,177,181,182,191,198,204,206,208,246,214,276,224,250,226,252,228,262,273) )";
		// new_exam_form = 'Y' or student_result_aug_22
	...
	public function student_result_permission($mode="",$course_id="",$class_id=""){
		...
		$data['not_permited_students']= $this->Common_model->getRecordByWhere('student',array("course_group_id"=>$course_id ,'class_id' => $class_id , 'old_result_show'=>'N' , 'exam_form'=>'Y' ,'university_mode'=>$mode ));
		// ,'examcentercode'=>'MDE165'
