...
// ));
	...
	public function tr_class_list(){
        ...
        $where = "id in (select distinct(course_group_id) from student where exam_form = 'Y' and class_id in (105,141,145,147,151,268) )";
        	
        	//  and class_id in (105,141,145,147,151,268)
