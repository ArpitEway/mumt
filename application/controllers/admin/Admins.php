...
public function update_exam_datewise_permission(){
	...
	public function generate_tr_bed($mode="",$course_group_id="",$class_id=""){
		$this->db->order_by('center_id,roll_number','ASC');
		$data['students'] = $this->Common_model->getRecordByWhere('student_result_aug_22',array("university_mode"=>$mode,"course_group_id"=>$course_group_id ,'old_class_id' => $class_id ,'exam_form'=>'Y','roll_number!='=>'0','student_id'=>'685381' ));
		//'result_show' => 'N'
		$data['class_id'] = $class_id;
		$data['course_group_id'] = $course_group_id;
