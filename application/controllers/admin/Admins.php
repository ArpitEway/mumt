...
public function update_exam_datewise_permission(){
	...
	public function tr_class_list(){
        ...
        $where = "id in (select distinct(course_group_id) from student where new_exam_form = 'Y' and class_id in (103,118,130,155,169,170,173,184,186,188,218,230,234,236,246,278,282,273,274))  ";
