...
public function update_exam_datewise_permission(){
	...
	public function tr_class_list(){
		$where = "id in (select distinct(course_group_id) from student where new_exam_form = 'Y' and class_id in (214,200,210,222,198,202,212,224,226,208,218,162,172,128,129))";
		/******Final TR*******/
