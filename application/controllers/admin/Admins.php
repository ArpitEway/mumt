...
public function update_exam_datewise_permission(){
	...
	public function tr_class_list(){
        ...
        $where = "id in (select distinct(course_group_id) from student where new_exam_form = 'Y' and class_id in (155,175,200,234,278,282,284,290,296,298,273,274,250,252,168,182,242,288,292,294,171,103,121,109,112,118,218,236,204,238,240,244,212,246,222,254))  ";
