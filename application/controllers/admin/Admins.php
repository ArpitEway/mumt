...
// ));
	...
	public function tr_class_list(){
		...
		$where = "id in (select DISTINCT(course_group_id) from student where examcentercode in ('MDE028','MDE172') and exam_form='Y' and old_class_id in (136,106,109,121,133,127,112,108,135,130,105,298,290,292,288,103,148,286,284,294,296,311))";
