...
public function update_exam_datewise_permission(){
	...
	public function generate_tr($mode="",$exam_pattern="M",$course_group_id="",$class_id="",$startlimit=0,$pagenumber=0){
		...
		// $class_cbcs = array(193,194,197,198,201,202,203,204,205,206,211,212,213,214,221,222,223,224,225,226,227,228,275,276,279,280);
        $class_cbcs = array(193,194,197,198,201,202,203,204,205,206,211,212,213,214,221,222,223,224,225,226,227,228,275,276,279,280,217,231,235,237,239,245,215,247,249,251,253,277,281,209,302,303,304,305,278,282,250,252,216,232,236,238,240,246,248,254,218,305,210,243,267,244);
	...
	public function tr_class_list(){
        ...
        $where = "id in (select distinct(course_group_id) from student where exam_form = 'Y' and class_id in (218,232,234,236,238,240,242,244,246,216,305,278,282,248,250,252,254) )";
	...
	public function internal_marks_list(){
		...
		$this->db->where_in('new_exam_form.int_marks',array('ABS','N'));
		 $this->db->where_in('student.old_class_id',array(218,232,234,236,238,240,242,244,246,216,305,278,282,248,250,252,254));
    ...
    public function practical_marks_list(){
		...
		$this->db->where('university_mode','REG');
		$this->db->where_in('student.old_class_id',[218,232,234,236,238,240,242,244,246,216,305,278,282,248,250,252,254]);
