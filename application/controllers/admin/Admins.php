...
public function update_exam_datewise_permission(){
	...
	public function tr_class_list(){
		$where = "id in (select distinct(course_group_id) from student where new_exam_form = 'Y' and class_id in (268,300,256,258,183,300,293,295,184,171,165,173,180,289,283,291))";
		/******Final TR*******/
