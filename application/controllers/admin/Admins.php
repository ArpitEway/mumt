...
public function update_exam_datewise_permission(){
	...
	public function student_notification_list($mode = "",$exam_pattern="M",$course_id="",$class_id="",$department="",$startlimit=0,$pagenumber=0){
		...
		$data['students']= $this->Common_model->getRecordByWhere('student',array("course_group_id"=>$course_id ,'class_id' => $class_id,'new_exam_form'=>'Y' ,'roll_no!='=>'0', 'university_mode'=>$mode,'exam_pattern'=>$pattern));//'result_show'=>'Y','old_result_show'=>'Y',
         // $this->Common_model->last_query();
	...
	public function tr_class_list(){
        ...
        $where = "id in (select distinct(course_group_id) from student where new_exam_form = 'Y' and class_id in (103,118,130,155,169,170,173,184,186,188,218,230,234,236,246,273,274,278,282))  ";
        
		//and class_id in (103,118,130,155,169,170,173,184,186,188,218,230,234,236,246,273,274,278,282)
		// and class_id in (102,110,120,135,141,165,299,180,202,206,303,226,228)
	...
	public function student_marksheet($mode="",$course_id="",$class_id="",$startlimit=0)
	{
		...
		if($class->last_class == 'L'){
           ...
           $data['students']= $this->Common_model->getRecordByWhere('student',array("course_group_id"=>$course_id ,'class_id' => $class_id,'new_exam_form'=>'Y','roll_no!='=>'0','university_mode'=>$mode,'result_show'=>'Y','exam_pattern'=>'MARKS'));
		}
	...
	public function internal_marks_list(){
		...
		$this->db->where_in('student.class_id',array(102,110,120,135,206,228,141,165,180,202,303));
...
public function forward_complaint(){
	...
	public function backlog_student_marksheet($mode="",$course_id="",$class_id="",$startlimit=0)
	{
		...
		if($class->last_class == 'L'){
			...
			$this->db->join('student','student.student_id = backlog_student.student_id');
			$this->db->where(array("backlog_student.course_group_id"=>$course_id ,'backlog_student.class_id' => $class_id,'backlog_student.exam_form'=>'Y','backlog_student.roll_no!='=>'0','student.course_complete'=>'Y','backlog_student.mode'=>$mode,'backlog_student.result_show'=>'Y','backlog_student.exam_year'=>'June 2024'));
			...
			$this->db->from('backlog_student');
			$this->db->join('student','student.student_id = backlog_student.student_id');
			$this->db->where(array("backlog_student.course_group_id"=>$course_id ,'backlog_student.class_id' => $class_id,'backlog_student.exam_form'=>'Y','backlog_student.roll_no!='=>'0','backlog_student.mode'=>$mode,'backlog_student.result_show'=>'Y' ,'backlog_student.exam_year'=>'June 2024'));
