...
public function update_exam_datewise_permission(){
	...
	public function backlog_tr_class_list(){
		$where = "id in (select distinct(course_group_id) from backlog_student where exam_form = 'Y' and exam_year='Dec 2024' and class_id in (154,155,181,182,217,229,197,231,205,209,213,215,302,279,281,247,223,249,225,251,227,253) )";
