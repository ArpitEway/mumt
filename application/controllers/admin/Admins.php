...
// ));
	...
	public function tr_class_list(){
        ...
        $where = "id in (select distinct(course_group_id) from student where exam_form = 'Y'  and class_id in (102,111,120,126,328,129,329,132,137,149,150,151,162,165,170,299,174,192))";
