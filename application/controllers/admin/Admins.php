...
public function update_exam_datewise_permission(){
	...
	public function generate_tr($mode="",$exam_pattern="M",$course_group_id="",$class_id="",$startlimit=0,$pagenumber=0){
		...
		// $class_cbcs = array(193,194,197,198,201,202,203,204,205,206,211,212,213,214,221,222,223,224,225,226,227,228,275,276,279,280);
        $class_cbcs = array(193,194,197,198,201,202,203,204,205,206,211,212,213,214,221,222,223,224,225,226,227,228,275,276,279,280,217,231,235,237,239,245,215,247,249,251,253,277,281,209,302,303,304,305,278,282,250,252,216,232,236,238,240,246,248,254,218,305,210,243,267,244,268,312,313,207,476,261);
...
// ));
	...
	public function tr_class_list(){
		...
		$where = "id IN (SELECT DISTINCT course_group_id FROM student WHERE new_exam_form = 'Y' AND  class_id IN (476,209,207,205,261,263))";	
