...
public function update_exam_datewise_permission(){
	...
	public function student_notification_list($mode = "",$course_id="",$class_id=""){
		...
		$data['mode']= $mode;
		$data['students']= $this->Common_model->getRecordByWhere('student',array("course_group_id"=>$course_id ,'class_id' => $class_id,'exam_form'=>'Y' ,'roll_number!='=>'0', 'university_mode'=>$mode,'old_result_show'=>'Y'));//'result_show'=>'Y'
	...
	public function tr_class_list(){
		...
		$where = "id in (select distinct(course_group_id) from student where exam_form = 'Y' and old_class_id in (193,194,197,198,201,202,203,204,205,206,211,212,213,214,221,222,223,224,225,226,227,228,275,276,279,280))";
	...
	public function backlog_tr_class_list(){
		$where = "id in (select distinct(course_group_id) from backlog_student where exam_form = 'Y' and exam_year='June 2023' and class_id not in (154,155,171,182,204) )";
		// new_exam_form = 'Y' or student_result_aug_22
