...
/*
	...
	public function get_exam_center_wise_backlog_student_attendance_sheet(){
		...
		$where = array('backlog_student.exam_center_id'=>$exam_center,'backlog_student.exam_form'=>'Y', 'backlog_student.roll_no!=' => 0 ,'backlog_student.notification_no'=>'4','backlog_student.exam_year'=>'Dec 2025');
		$this->db->where($where);	
		$data['exam_center_students'] = $this->db->get()->result();
...
/*
	...
	public function exam_center_folio(){
		...
		$this->db->where('examcentercode','MDE172');
...
public function getStudentData()
{
	...
	{
		$roll_no = $this->input->post('roll_no');
		$where = array('backlog_student.roll_no'=>$roll_no,'backlog_student.exam_form'=>'Y','backlog_student.exam_year'=>'June 2025');
