...
/*
	...
	public function exam_center_wise_student_attendance_sheet(){
		...
		}else
		{
			...
			$where = array('new_exam_form'=>'Y', 'roll_no!=' => 0 ,'notification_no'=>21);
			$this->db->where($where);
	...
	public function get_exam_center_wise_student_attendance_sheet(){
		...
		// if($exam_center!="All")
		$where = array('exam_center_id'=>$exam_center,'new_exam_form'=>'Y', 'roll_no!=' => 0 ,'notification_no'=>21);
		$this->db->where($where);	
	...
	public function exam_center_wise_backlog_student_attendance_sheet(){
		...
		}else
		{
			...
			$this->db->where('notification_no','21');
	...
	public function get_exam_center_wise_backlog_student_attendance_sheet(){
		...
		$where = array('backlog_student.exam_center_id'=>$exam_center,'backlog_student.exam_form'=>'Y', 'backlog_student.roll_no!=' => 0 ,'backlog_student.notification_no'=>'21','backlog_student.exam_year'=>'Dec 2025');
		$this->db->where($where);	
		$data['exam_center_students'] = $this->db->get()->result();
