...
/*
	...
	public function get_exam_center_wise_backlog_student_attendance_sheet(){
		...
		$where = array('backlog_student.exam_center_id'=>$exam_center,'backlog_student.exam_form'=>'Y', 'backlog_student.roll_no!=' => 0 ,'backlog_student.notification_no'=>17,'backlog_student.exam_year'=>'June 2025');
		$this->db->where($where);	
		$data['exam_center_students'] = $this->db->get()->result();
...
/*
	...
	public function class_wise_backlog_result_upload_status(){
		...
		if(!$this->session->has_userdata('adminData')){
			...
			$course_group = $this->Common_model->get_record('backlog_student','DISTINCT(class_id) as  class_id, course_group_id' ,array('exam_form'=>'Y','exam_year'=>'Dec 2024'));
...
public function getStudentData()
{
	...
	{
		$roll_no = $this->input->post('roll_no');
		$where = array('backlog_student.roll_no'=>$roll_no,'backlog_student.exam_form'=>'Y','backlog_student.exam_year'=>'Dec 2024');
