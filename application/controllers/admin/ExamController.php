...
/*
	...
	public function get_exam_center_wise_backlog_student_attendance_sheet(){
		...
		$where = array('backlog_student.exam_center_id'=>$exam_center,'backlog_student.exam_form'=>'Y', 'backlog_student.roll_no!=' => 0 ,'backlog_student.notification_no'=>29,'backlog_student.exam_year'=>'June 2024');
		$this->db->where($where);	
		$data['exam_center_students'] = $this->db->get()->result();
