...
class Dataentry extends CI_Controller {
 ...
 public $exam_form_table;
...

	{
		...
		$data['examSession']="December 2025";
...

	{
		...
		$where = array('backlog_exam_form.paper_code' => $paper_code, 'theory_marks' => '','mode' => $mode,'paper_type' => 'theory','exam_center_id'=>$exam_center,'backlog_student.exam_form' => 'Y','backlog_student.exam_year'=>'Dec 2025');
		//,'student.result_show'=>'N'
