...
class Dataentry extends CI_Controller {
 ...
 public $exam_form_table;
...

	{
		...
		$where = array('backlog_exam_form.paper_code' => $paper_code, 'theory_marks' => '','mode' => $mode,'paper_type' => 'theory','exam_center_id'=>$exam_center,'backlog_student.exam_form' => 'Y','backlog_student.exam_year'=>'June 2025');
		//,'student.result_show'=>'N'
