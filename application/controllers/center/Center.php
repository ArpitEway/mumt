...
// Output to JSON format
	...
	public function getUnpaidFeesList($param1 = ''){
		...
		if($param1=='Admission'){
			...
			$where.=" or (student.student_id in (715231, 715241, 716487, 717657, 717662, 722810) and online_payment_transaction.payment='N' AND online_payment_transaction.center_id=1352)";
...
// Output to JSON format
 ...
 public function grade_marksheet($student_id=""){
	...
	public function practical_marks_list(){
		...
		$this->load->view('Centers/header',$titleData);
		$center_id =  $this->session->center_id;
		$where = array('university_mode' => 'REG','center_id' => $center_id,'result_show' => 'N','exam_form' => 'Y');
