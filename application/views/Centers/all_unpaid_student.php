  ...
  $(document).on('click','.pay1',function(){
	...
	var frm = new FormData(formimage[0]);
		...
		$(document).on('click','.deleteForm',function(){
				...
				Swal.fire({
						title: "Are you sure?",
						text: "Form को Delete करने से पहले यह सुनिश्चित कर ले कि इसका Payment आपने नहीं किया है, अगर किया है और Payment अपडेट नहीं हुआ है तो पहले 'Payment Complaint Option' में जाकर Complaint करे|  ",
						icon: "info",
						showCancelButton: true,
						confirmButtonText: "Yes"
					}).then(function(result) {
