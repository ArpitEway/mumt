		...
		<tbody>
			...
			foreach($students as $student){
				...
				<tr>
					...
					<td><a target="_blank" href="<?=base_url('center/center/backlog_admit_card/'.$this->Common_model->encrypt_decrypt($student->student_id,'encrypt'));?>"><i class="far fa-eye text-info mr-5"></i></a></td>	
