						...
						<div class="login-form login-signin">
							...
							<form class="form" method="post" action="<?=base_url('center/center/loginSub')?>" >
								<div class="form-group py-3 m-0">
									<input class="form-control  placeholder-dark-75" type="text" placeholder="center Code" name="centercode" maxlength="4" minlength="10" id="centercode" autocomplete="off" required />
								</div>
