  ...
  <p style="text-align:center;font-size:12px;">
    <strong>
        ...
        <?= ($paper_list[0]['class_id'] == 215)
            ? 'December 2025'
            : (in_array($paper_list[0]['class_id'], [502, 510, 432, 506, 464, 497,332,264,270,])
                ? 'February 2026'
                : 'January 2026'
            )
        ?>
...
<?php } ?>
    ...
    -->
<?php
$class_ids = array(193,197,199,201,203,205,302,207,209,211,213,221,227,275,279,223,225,460,476,261,263,267,269,264,270,264,270);
