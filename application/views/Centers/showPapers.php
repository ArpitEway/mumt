	...
	<div id="printablediv">
		<div class="mt-5">
			<?php if($student['regular_exam_form_permission'] =='Y'){ ?>
				...
				<strong>आवश्यक सूचना :</strong> सूचित किया जाता है कि मई - जून 2026 में आयोजित होने वाली परीक्षाएं विश्वविद्यालय के मुख्यालय करौंदी जिला कटनी में आयोजित की जाएगी।
				</div>
			<?php }?>
