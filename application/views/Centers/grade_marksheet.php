 ...
 <table class="table mb-0" >
    ...
    * Grade In Repeat Examination.<br><br>
    <?php if($gradesheetData['result'] != ''){ 
      ...
      if($classData->last_class == 'L' && (!in_array($student->center_id,$dept_ids) || in_array($student->old_class_id ,[103,121,112]))){
        ...
        foreach($classes as $cls){
            ...
            $gradeData = $this->Gradesheet_model->view_old_results($student->student_id,$student->course_group_id,$old_result[0]->class_id,$student->university_mode, $old_result[0]->id, $old_result[0]->exam_status);
        ...
        <?php
          ...
          (count($attemp_count)==0 || count($attemp_count)==1)?'One': $wordNumerals[count($attemp_count)]
