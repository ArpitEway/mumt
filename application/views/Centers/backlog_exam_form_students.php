            ...
            // }
               $pending="";
				if(in_array($this->session->center_id, $center_ids) ){
                     $where=array('center_id'=>$student->center_id,'exam_session'=>'June 2026','fees_head'=>'Backlog Exam Fees','payment'=>'Y','student_id'=>$student->student_id,'class_id'=>$student->class_id);
