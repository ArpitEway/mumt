...
<div id="printThisDivIdOnButtonClick" class="mt-10">
	...
	<?php $student_id = $this->Common_model->encrypt_decrypt($student['student_id']); ?>
			<div class="row justify-content-center mt-10">
				...
				<a class="btn btn-success mx-6" id="process" href="<?= base_url('center/payment/admission/'.$student_id) ?>">Process To Payment</a>
				<a class="btn btn-info" id="print" onclick="return printhiv('printarea')">Print</a>
