<div id="ss">
    ...
    <p style="text-align:center;font-size:12px;"><strong>Programme for Annual/Semester - Main/Backlog Examination March 2023 </strong></p>
        ...
        <tbody>
            ...
            <?php $i=1; foreach($paper_list as $rows){  ?>
                <tr bgcolor="#E8F6FF">
                    ...
                    <td align="center"><?php echo date("d-m-Y", strtotime($rows['old_exam_date'])); ?></td>
                    <td align="center"><?=$rows['old_exam_day']?></td>
                    <td align="center"><?=$rows['old_exam_shift']?></td>
