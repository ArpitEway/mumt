				  ...
				  if($center->admission_permission_private=='Y' ) // && !in_array($center_id, $center_ids_dep)
				   {
				 	...
				 	$pending = $this->Common_model->getCountByWhere('online_payment_transaction','center_id='.$this->session->center_id.' and  fees_head="Admission Fees"  and payment="N"  and payment_status="pending" and admission_type="Private" and created_at > "2024-08-11"');
					// and remark="With Late Fees"
				 	$failureCount = $this->Common_model->getCountByWhere('online_payment_transaction','center_id='.$this->session->center_id.' and  fees_head="Admission Fees"  and payment="N" and payment_status!="pending" and admission_type="Private" and created_at > "2024-08-11"');
					...
					*/
					...
					<?php if ($center->result_permission=='Y'): ?>
						<a class="border-0 custom-menu-item" href="<?=base_url('result');?>">
							<div>
								<span class="nav-text">Result(Jan 2026)</span>
							</div>
						</a>
						
						<a class="border-0 custom-menu-item" href="<?=base_url('backlog_result');?>">
							<div>
								<span class="nav-text">Backlog Result (Jan 2026)</span>
							</div>
						</a>
...
Swal.fire({
	 text:  "सत्र २०२५-२६ के नियमित पाठ्यक्रम - पी ज़ी डिप्लोमा / डिप्लोमा / प्रमाणपत्र को छोड़कर स्नातक एवं स्नातकोत्तर पाठ्यक्रमों में प्रवेशित समस्त छात्रों का अध्यापन कार्य एवं उनकी परीक्षा विश्वविद्यालय मुख्यालय करौंदी में सम्पन्न होगी| ",
	 icon: "info",
...
$("#main-exam").click(function (e) {
    Swal.fire({
        html: '<b> आवश्यक सुचना :- </b>सूचित किया जाता है कि विश्वविद्यालय की मई - जून 2026 में आयोजित की जाने वाली परीक्षाओं  हेतु  परीक्षा आवेदन पत्र भरने की अंतिम तिथि 9 मई 2026 (बिना  विलम्ब शुल्क के) एवं विलम्ब शुल्क 200 रुपये सहित परीक्षा आवेदन पत्र भरने की अंतिम तिथि 16 मई 2026  निर्धारित की गयी है। उक्त निर्धारित तिथि तक परीक्षा आवेदन पत्र भरने की प्रक्रिया पूर्ण करे | इस सम्बन्ध में अधिक जानकारी के लिए 9343609316 पर संपर्क करे|',
        icon: "info",
        showCancelButton: true,
        confirmButtonText: "I Agree",
        didOpen: () => {
...
$(".karaundi-exam").click(function (e) {
	...
	let html = '<b> आवश्यक सुचना :- </b>सूचित किया जाता है कि मई - जून 2026 में आयोजित होने वाली परीक्षाएं विश्वविद्यालय के मुख्यालय करौंदी जिला कटनी में आयोजित की जाएगी | सूचित किया जाता है कि विश्वविद्यालय की मई - जून 2026 में आयोजित की जाने वाली परीक्षाओं  हेतु  परीक्षा आवेदन पत्र भरने की अंतिम तिथि 9 मई 2026 (बिना  विलम्ब शुल्क के) एवं विलम्ब शुल्क 200 रुपये सहित परीक्षा आवेदन पत्र भरने की अंतिम तिथि 16 मई 2026  निर्धारित की गयी है। उक्त निर्धारित तिथि तक परीक्षा आवेदन पत्र भरने की प्रक्रिया पूर्ण करे | इस सम्बन्ध में अधिक जानकारी के लिए 9343609316 पर संपर्क करे| ';
