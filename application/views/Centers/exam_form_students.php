    ...
    <table id="kt_datatable_scroll" class="table table-striped nowrap"  >
       ...
       <tbody>
         ...
         foreach($documents as $student){
           // echo "test".$student->class_id; 
            if($student->university_mode=="REG" && $student->session=="July 2023" && $student->class_name== 'I Year' && (in_array($student->course_group_id,$exam_course_not)) ){
