			...
			<div class="BoxC border- padding mar-bot">
				<div class="row">
					<div class="col-12 text-center">
						<h5>Schedule of Exam for Annual/Semester Examination of <?=($student[0]->class_id == 215)?"December 2025" : (in_array($student[0]->class_id, [502, 510, 432, 506, 464, 497,332,255,257,259,316,314,495])
                ? 'February 2026'
                : 'January 2026'
            )?> 	</h5>
...
<!-- 			<div class="BoxE border- padding mar-bot txt-center">
			...
			foreach($papers as $paper){
				...
				<tr>
					...
					<?php //endif ?> -->
					<td><?php
					// $class_ids=array(154,172,181,213);104,101,107,110,116,119,273,125,128,131,134,162,163,164,165,283,285,287,289,310,291,293,295,274,297,168,169,170,171,214,106,103,109,112,118,121,127,130,133,136,264,137,149,183,185,191,138,184,192,187,143,146,139,144,188,145,147,148,150,186,141,151,142,190,140,189,173,174,175,177,180
					$class_ids = array(193,197,199,201,203,205,302,207,209,211,213,221,227,275,279,223,225,460,476,261,263,267,269,495);
						if($student[0]->university_mode == 'PVT' && in_array($student[0]->class_id,$pvtClasses)){
							...
							elseif($paper->exam_shift=='Afternoon' && in_array($student[0]->class_id,[502, 510, 432, 506, 332,255,257,259,316,314])){  ?>
