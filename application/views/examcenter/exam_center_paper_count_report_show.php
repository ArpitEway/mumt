...
foreach($papers as $pap)
{
   ...
   <table width="95%" align="center" cellspacing="0" cellpadding="8" border="1">
      ...
      { 
         ...
         $where="`e`.`paper_code` = '".$paper->paper_code."' AND `s`.`class_id` = '".$paper->class_id."'  AND s.course_group_id='".$paper->course_group_id."'  AND s.exam_center_id='".$exam_center."' AND exam_year='June 2024'";
