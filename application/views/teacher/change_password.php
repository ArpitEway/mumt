<div class="container">
	<form  method="POST" class="p-4 ajaxForm col-md-9 m-auto">
		...
		<div class="form-group row">
			...
			<div class="col-lg-9 col-xl-6">
				<input type="password"  name="new_password" id="new_password1" class="form-control form-control-lg form-control-solid"  placeholder="New password">
			</div>
		</div>
		<div class="form-group row">
			<label class="col-xl-3 col-lg-3 col-form-label text-alert">Verify Password</label>
			<div class="col-lg-9 col-xl-6">
				<input type="password" name="passconf" id="passconf" class="form-control form-control-lg form-control-solid"  placeholder="Verify password">
			</div>
		</div>
