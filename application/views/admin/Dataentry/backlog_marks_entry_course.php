<form  class="d-block ajaxForm" target="_blank" method="POST"  action="<?php echo site_url ('Dataentry/backlog_marks_entry_form'); ?>">
   <div class="row">
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url:BASE_URL+'admin/Dataentry/getBacklogPaperByClassId',
            type:'post',
            dataType : 'JSON',
            data: data,
