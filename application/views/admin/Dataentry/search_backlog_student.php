<form id="radio_btn_select">
    ...
    <div class="row d-flex justify-content-center">
            <div class="form-group">
                <button type="button" class="btn btn-primary" onclick="search_backlog_student_data()">Submit</button>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        if(roll_no!=''){
            search_backlog_student_data();
        }
    });
    function search_backlog_student_data(){
        ...
        if(roll_no==''){
            ...
            $.ajax({
                url: BASE_URL+'admin/<?=$this->session->account_type;?>/getEditBacklogStudentMarksData',
                type:'post',
                dataType : 'JSON',
