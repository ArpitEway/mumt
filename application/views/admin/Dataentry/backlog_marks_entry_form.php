...
<div class="container">
	...
	<table class="w-100 mt-10 table-secondary table ">			
		...
		<tr>
			...
			<th>Date of Exam:</th>
			<td><?php echo (in_array($papers->class_id, array(104,107,134)) && $university_mode =='PVT')?$papers->pvt_exam_date:$papers->exam_date; ?></td>
		</tr>
		<tr>
			<th>Exam Session:</th>
			<td><?=$examSession?></td>
	...
	<script>
		$(document).ready(function(){	
			...
			$("#submit").on('click',function (){
				 ...
				 $.ajax({
				 	url: BASE_URL+"admin/Dataentry/backlog_marks_entry_form_sub",
				 	type: 'POST',
				 	dataType : 'json',
				 	data: serialized ,
