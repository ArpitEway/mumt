<form method="POST" class="d-block ajaxForm" action="<?php echo site_url('admin/Placement/company/add'); ?>">
    <div class="form-row" >
        ...
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" id="min_qualification" name="min_qualification" placeholder="Enter Min Qualification" required>        
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            ...
            <textarea class="form-control description" placeholder="Other Detail" id="kt_autosize_2" rows="4" name="other detail"></textarea>
        </div>
