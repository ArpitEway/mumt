<div class="mt-3">
    <a href="<?= BASE_URL('admin/Admins/centers') ?>" class="btn btn-outline-primary float-right">Centers</a>
</div>
                    ...
                    foreach ($courses as $course) {
                        if (in_array($course['id'], $allot_course_group_id)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" name="course_group_id[]" id="course_group_id" value="<?= $course['id']; ?>"
                                        <?php if (in_array($course['id'], $allot_course_group_id)) { ?> checked="checked" <?php } ?>>
                                </td>
                            </tr>
                            <?php
                        }
    ...
    $("#center_submit").on('click', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data) {
                    console.log(data);
                    toastr.success("Allotted Course Successfully");
                } else {
