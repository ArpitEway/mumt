...
<!-- 	<div class="form-group col-md-12">
	...
	<div class="form-group col-md-4">
		...
		$states = $this->db->get_where('state', array())->result_array();
           ...
           <option value="<?php echo $state['state_id']; ?>" <?php  if($center['state'] == $state['state_id']){ echo "selected"; } ?> ><?php echo $state['name']; ?></option>
            <?php
             } 
			?>
	...
	<div class="form-group col-md-4">
		...
		<?php
		$Distt = $this->db->get_where('distt', array("state_id" => $center['state']))->result_array();
		
				foreach($Distt as $dist)
                    {
                    ?>
					
           <option value="<?php echo $center['district']; ?>" <?php  if($center['district'] == $dist['distt_id']){ echo "selected"; } ?>   ><?php echo $dist['name']; ?></option>
	...
	<div class="form-group col-md-4">
		<label for="class">Contact Person 1</label>
		<input type="text" class="form-control" id="contact_person" name="contact_person" value="<?php echo $center['contact_person']; ?>" placeholder="Enter contact person" required >
	</div>
	<div class="form-group col-md-4">
		<label for="class">Mobile no.</label>
		<input type="text" class="form-control" id="mobile_no" name="mobile_no" placeholder="Enter mobile no" value="<?php echo $center['mobile_no']; ?>"  >
	</div>
	...
	<div class="form-group col-md-4">
		...
		<input type="text" class="form-control" id="contact_person_2" name="contact_person_2" value="<?php echo $center['contact_person_2']; ?>" placeholder="Enter contact person" required >
	</div>
	<div class="form-group col-md-4">
		<label for="class">Other Mobile no</label>
		<input type="text" class="form-control" id="other_mobile_no" name="other_mobile_no" placeholder="Enter mobile no" value="<?php echo $center['other_mobile_no']; ?>"  >
	</div>
	
	<div class="form-group col-md-4">
		<label for="class">Other Mobile no 2</label>
		<input type="text" value="<?php echo $center['other_mobile_no_2']; ?>" class="form-control" id="other_mobile_no_2" name="other_mobile_no_2" placeholder="Enter mobile no"  >
	</div>
	<div class="form-group col-md-4">
