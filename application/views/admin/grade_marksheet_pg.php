      ...
      if($class->last_class == 'L'){
        ...
        * Grade In Repeat Examination.<br><br>
        ...
        foreach($classes as $cls){
            ...
            $gradeData   = $this->GradeSheet_old_model_pg->view_old_results($exam_data->student_id,$exam_data->course_group_id,$cls->id,$exam_data->university_mode,$old_result[0]->id);
