                ...
                <table class="mytable" border="0" cellpadding="2" cellspacing="2" width="100%">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="resultText">
                        <div align="left"><span id="lblSemesterGrading" style="color:Black;">N/C</span></div>
                      </td>
                    </tr>
                    <?php } ?>
                    <tr>
                    ...
                    <table id="" style="width:100%;" border="0" cellspacing="0" cellpadding="0" align="center">
                      <tbody>
                        ...
                        <tr style="font-family:Verdana;font-size:9px;" align="center">
                          ...
                          <td width="8%" rowspan="2" scope="col" ><strong><u>Th/Pr/Pj</u></strong></td>
                          <td width="6%" rowspan="2" scope="col" ><strong><u>Total</u></strong></td>
