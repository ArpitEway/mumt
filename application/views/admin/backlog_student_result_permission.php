<form method="post" action="<?=base_url('admin/Admins/update_backlog_student_result_permission')?>" class="mt-3" >
...
<table class="table table-striped my-5" id="kt_datatable_3">
	<thead>
        ...
        $student =  $this->Common_model->getRecordById('student','student_id', $students->student_id); 
        ?>
        <tr>
        ...
        <td><?php  echo $this->Common_model->getClassNameByClassId($students->class_id);  ?></td>
