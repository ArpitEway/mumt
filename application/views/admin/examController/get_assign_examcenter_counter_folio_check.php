<form method="post"  action="<?=base_url('ExamController/show_counter_folio_check');?>" class="mt-3 answersheet" target="_blank">
               ...
               // print_r($examcenters);die;
				...
				{  
					...
					<tr>
						...
						<td class="font-weight-bolder text-primary"><?php echo $center->examcentercode;?></td>
