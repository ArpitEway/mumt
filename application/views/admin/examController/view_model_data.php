...
<form id="ajaxForm">
  ...
  <div class="row py-3">
    ...
    <div class="col-6 text-center">
      <a target="_blank" class="btn btn-primary" href="<?php  echo base_url('admin/ExamController/check_answersheet_pdf/'.$this->Common_model->encrypt_decrypt($details[0]->id,'encrypt'));?>" >View</a>
    </div>
  </div>
  <hr>
...
<script>
  ...
  $.ajax({
    url: '<?php echo site_url('admin/ExamController/question_paper_sub'); ?>',
    method: 'post',
    data: frm,
    dataType: 'JSON',
