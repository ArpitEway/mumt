<div class="text-center">
    <a   target="_blank" class="btn btn-warning" href="<?php  echo base_url('admin/ExamController/view_question_pdf/'.$this->Common_model->encrypt_decrypt($answersheetData[0]->paper_code,'encrypt'));?>" >View paper</a> 
     </div> 
...
<script>
	...
	$(document).ready(function(){
		...
		$(".student").click(function(){
			...
			$.ajax({
				type: "POST",
				url: BASE_URL+"admin/ExamController/student_details_uplode",
				dataType:"JSON",
