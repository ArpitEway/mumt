...
foreach($centers as $center)  {
	...
	$where = array('backlog_student.center_id'=>$center->id, 'backlog_student.roll_no!=' => 0 ,'backlog_student.exam_form'=>'Y','backlog_student.exam_year'=>'Dec 2022');//,'marksheet_dispatch' =>'N'
	$this->db->where($where);	
