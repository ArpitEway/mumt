  ...
  foreach($students as $student)
  {
   ...
   if($fc2_abs === 'ABSABS'){
    ...
    if($page_break_count%4==0 || $page_break_count==0 || $previous_center!=$current_center){
      ...
      <div>
        <div style="float: left;">DATE: <?php echo ($student->mode == 'REG')? $marksheetData[0]->backlog_result_date: $marksheetData[0]->backlog_pvt_result_date;?></div>
    ...
    // echo $std[0]->sub_group_id .'ss';die;
    ...
    ?>
     <td  class="align-middle text-center total" rowspan='2'>Total</td>
          ...
          if($check_grace_marks){
            ...
            elseif(($int_abs_count == $count_int && $count_int!=0)  || ($p_abs_count == $count_practical && $count_practical!=0)){
          ...
          <?php if($new_exam_form->paper_type=="theory" && $student->mode != 'PVT'){
              ...
              if($new_exam_form->theory_marks==''){
                ...
                if($new_exam_form->sub_group_id == 1){
                 ...
                 }elseif($this->foundation2>0 && $new_exam_form->group_paper_name =='FC2'){
                   echo ($check_grace_marks) ? ' G' : ' F';
                 }else{
                  echo $status;
                 }
...
$classes = $this->Common_model->getRecordByWhere("class_master",array('course_group_id'=>$student->course_group_id,'mode'=>$classData->mode,'id!='=>$class_id
,'class_name!='=>'IV Year'));
$total_ob =0;
$total_mar=0;
$total_grade_point = 0;
