		...
		<tbody>
			...
			foreach($counts as $count){ ?>
				<tr>
					...
					<?php 
					$where = array('exam_form'  =>'Y','class_id'=>$count['class_id']);
					$Permitted = $this->Common_model->getCountByWhere('backlog_student',$where);
					$where_reg = array('exam_form'  =>'Y','mode'  =>'REG','class_id'=>$count['class_id']);
					$Permitted_reg = $this->Common_model->getCountByWhere('backlog_student',$where_reg);
					$where_pvt = array('exam_form'  =>'Y','mode'  =>'PVT','class_id'=>$count['class_id']);
