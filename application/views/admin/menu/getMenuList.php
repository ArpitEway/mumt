...
<table id="mytable" class="table">
			...
			<tr id="<?php echo $menu['id'];  ?>" data-id = "tr_<?php echo $menu['id']; ?>">
				...
				<td><?php echo $this->Common_model->getHeadingNameById($menu["heading_id"]); ?></td>
				...
				<td>		
                	<div style="display: inline-flex;">
						<a href="javascript:void(0);" class="btn btn-sm btn-info" onclick="rightModal('<?php echo site_url('admin/modal/popup/admin/menu/menu_edit/'.$menu['id']); ?>', '<?php echo 'Update menu' ?>')"> <i class="text-white fas fa-pen"></i></a>  
