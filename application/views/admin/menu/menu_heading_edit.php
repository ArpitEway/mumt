<?php
$menu_headings = $this->db->get_where('menu_heading', array('id' => $param1))->result_array();
	...
	<div class="form-row">
		...
		<div class="form-group col-md-4">
			...
			<option value="all">Select admin</option>
				...
				<option value="<?php echo $admin['id']; ?>" <?php if($admin['id'] == $menu_heading['admin_id']){ echo "selected"; } ?>><?php echo $admin['name']; ?></option>
...
<script>
	...
	$.ajax({
		url: '<?php echo site_url('admin/admins/add_menu_heading/update/'.$param1); ?>',
		type: 'POST',
		dataType : 'json',
		data: frm,
