 ...
 <div class="  text-center p-3">
     ...
     <div class="form-group col-md-6 mx-auto">
        ...
        <select  name="exam_center" readonly="readonly" id="exam_center" class="form-control course" required>
            ...
            {
                ?>
                <option value="<?php echo $ecenter->exam_center_id; ?>"   ><?php echo $ecenter->exam_center_code;
                //.' ('.$ecenter->schoolcollegename.')'; ?></option>
                <?php
            } 
            ?>
        </select>
...
<script>
  ...
  //var multiple=$("#multiple").val();
		$.ajax({
			method: "POST",
			url: BASE_URL+"ExamController/get_exam_center_wise_backlog_student_attendance_sheet",
