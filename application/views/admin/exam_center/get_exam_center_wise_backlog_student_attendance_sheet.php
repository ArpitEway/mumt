			...
			<div class="BoxC border- padding">
				<div class="row">
					<div class="col-12 text-center">
						<h5>ATTENDANCE SHEET FOR ANNUAL/SEMESTER BACKLOG EXAMINATION OF <?=($student->class_id == 215)?"December 2025":(in_array($student->class_id, [502, 510, 432, 506, 464, 497,332,264,270])
                ? 'February 2026'
                : 'January 2026'
            )?>
						</h5>
