...
foreach($students as $student){
    ...
    ?>
     ...
     <?php
    // echo $student->name.' - '.$student->enrollment_no;
    //  print_r($classes);
    // echo '<br>';
     if($gradesheetData['result'] == '' || $gradesheetData['result'] == 'Fail' || $gradesheetData['result'] == 'RW' || $gradesheetData['equivalent'] == 0 || $gradesheetData['tot_credit'] <40){
...
// $this->Common_model->last_query();
        $gradeData = $this->Gradesheet_model->view_old_results($student->student_id,$student->course_group_id,$old[0]->class_id,$student->university_mode, $old[0]->id, $old[0]->exam_status);
    ...
    //  echo  $total_grade_point.' -- '.$total_course_credit;
