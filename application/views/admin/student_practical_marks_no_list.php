				...
				?>
				   <tr>
					...
					<?php }
						...
						<button  class="btn btn-primary btn-sm font-weight-bold student" id="<?="roll_{$student->student_id}"; ?>" data-toggle="modal" data-target="#kt_datepicker_modal"  data-id="<?=$student->student_id;?>" onclick="mark_submission(<?=$student->student_id;?>,<?=$student->class_id; ?>)">Edit</button>
...
<script>
		...
		function mark_submission(student_id,class_id){
		...
		function view_mark(student_id,class_id){
			var student_id = student_id;
			var class_id =class_id;
			var csrfName = $('.csrfname').attr('name');
			var csrfHash = $('.csrfname').val();
