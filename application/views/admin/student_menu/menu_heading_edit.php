<?php
$menu_headings = $this->db->get_where('student_menu_heading', array('id' => $param1))->result_array();
...
<script>
	...
	$.ajax({
		url: '<?php echo site_url('admin/admins/add_student_menu_heading/update/'.$param1); ?>',
		type: 'POST',
		dataType : 'json',
		data: frm,
