			...
			<tr id="<?php echo $heading['id'];  ?>" data-id = "tr_<?php echo $heading['id']; ?>">
				...
				<td>		
                	<div style="display: inline-flex;">
						<a href="javascript:void(0);" class="dropdown-item" onclick="rightModal('<?php echo site_url('admin/modal/popup/admin/student_menu/menu_heading_edit/'.$heading['id']); ?>', '<?php echo 'Update heading' ?>')"> <i class="mdi mdi-pencil edit-icon"></i></a>   
...
$("#heading_submit").on('click',function (e){
	...
	$.ajax({
		url: '<?php echo site_url('admin/admins/add_student_menu_heading/create'); ?>',
		type: 'POST',
		dataType : 'json',
		data: frm,
		...
		if(datas.status == "true"){
			var data = "";
				var url = BASE_URL+"admin/Admins/get_student_heading_data"; 
				var response = call_ajax(data,url);
