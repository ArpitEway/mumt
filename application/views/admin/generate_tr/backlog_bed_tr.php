...
<?php
  ...
  foreach($students as $student)
  {
    ...
    $page_break_count++;
    $marks = $this->Common_model->backlog_student_info_for_BEd_result($student->student_id,$student->class_id,$student->id);
    ...
    if($page_break_count%2==0 || $page_break_count==0 || $previous_center!=$current_center){
      ...
      <p align="center" class="line-height">Tabulation Register for <strong><?php echo $student_info->course_name; echo '&nbsp'. $marksheetData[0]->class_name; ?></strong> <?php echo ' Backlog '.$marksheetData[0]->exam_session;?>
      </p>
      <!--<p align="center" class="line-height">Directorate of Distance Education</p>-->
      <div>
        <div style="float: left;">DATE: <?php if($student->mode != 'PVT') echo $marksheetData[0]->backlog_result_date;else echo $marksheetData[0]->pvt_result_date;?></div>
      ...
      <tbody>
        <tr>
          ...
          <th  class="align-middle text-center photo" rowspan="<?php echo $rowspandata ?>">
            <img alt="N/A" src="<?= base_url('assets/student_image/'.$student_info->session.'/'.$student_info->photo) ?>" width='65px' height="90px"></th>
...
<?php } ?>
  <tr>
    ...
    //   }else
      if(($paper_master->theory_marks<$paper_master->min_theory_marks) || ($paper_master->int_marks<$paper_master->min_internal_marks) || $paper_master->theory_marks=='ABS'|| $paper_master->int_marks=='ABS'){
