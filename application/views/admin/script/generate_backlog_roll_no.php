		...
		<table class="table table-hover">
			...
			<tbody>
				...
				if($action =='generate' || $action=='view'){
						...
						// $this->db->where_not_in('class_id',array(267,269));				
						...
						$whereRollNo = "exam_form = 'Y' and roll_no !='0' and exam_year = 'Dec 2025'";
						...
						foreach ($students as $student) {
							...
							if($action=='generate'){
								$whereUpdate = array('student_id' => $student->student_id,'exam_year'=>'Dec 2025','class_id' => $student->class_id);
