...
<table class="table table-striped" id="kt_datatable">
	<tbody>
		...
		<?php foreach ($courses as $course){
			...
			// $this->db->where_in('id',array(175,163,299,154,155,159,160,162,164,165,182,169,170,171,194,196,198,200,202,204,206,208,210,212,214,222,224,226,228,273,274,168,172,173,174,177,178,180,181,191,183,137));
