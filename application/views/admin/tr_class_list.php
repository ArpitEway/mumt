...
<table class="table table-striped" id="kt_datatable">
	<tbody>
		...
		// $this->db->where_in('id', array(197,201,203,211,213,221,223,225,275,279,302));
		$this->db->where_in('id', array(136,106,109,121,133,127,112,108,135,130,105,298,290,292,288,103,148,286,284,294,296,311	));
