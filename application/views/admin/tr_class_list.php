...
<table class="table table-striped" id="kt_datatable">
	<tbody>
		...
		$this->db->where_in('id', array(476,209,207,205,261,263));
        ...
        ?>
			...
			<td>
				...
				// if ($class->practical_internal_marks=='Y' && $class->id !=205 && $class->id !=206 && $class->id !=239 && $class->id !=278&& $class->id !=282){ 
					 $class_pg= array(205,206,239,240,248,278,282,252,267,268,312,313,197,201,203,211,213,221,223,225,275,279,302,476,261);
