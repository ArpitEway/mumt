...
<table class="table table-striped" id="kt_datatable">
	<tbody>
		...
		<?php foreach ($courses as $course){
      	 ...
      	 $this->db->where_in('id', array(193,217,197,231,203,237,211,275,277,279,281,221,247,223,249,225,251,263,155,182,205,239,213,302,304,245,199,233,201,235,241,227,253,154,181));
