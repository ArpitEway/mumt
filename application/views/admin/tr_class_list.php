	...
	<tbody>
		...
		<?php foreach ($courses as $course){
			$this->db->order_by('id');
			 ...
			 $this->db->where_in('id',array(193,194,197,198,201,202,203,204,205,206,211,212,213,214,221,222,223,224,225,226,227,228,275,276,279,280));
			//101,228,126,108,111,117,285,262,293,295,107,125,298,105,270,116,110,104
