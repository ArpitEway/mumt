...
<table class="table table-striped" id="kt_datatable">
	<tbody>
		...
		<?php foreach ($courses as $course){
			$this->db->order_by('id');
			$this->db->where_in('id',array(102,110,111,112,119,120,121,125,126,127,129,131,132,133,149,150,163,168,299,175,182,191,192,198,232,240,242,212,214,226,252,254,258));
