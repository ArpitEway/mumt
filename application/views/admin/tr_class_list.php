...
<table class="table table-striped" id="kt_datatable">
	<tbody>
		...
		<?php foreach ($courses as $course){
		  ...
		  $this->db->where_in('id',array(193,195,229,197,231,199,233,201,235,203,237,205,239,302,207,241,209,243,211,245,213,215,221,247,275,277,279,281,223,225,227,253,,299));
