...
<table class="table table-striped" id="kt_datatable">
	<tbody>
		...
		<?php foreach ($courses as $course){
      	 ...
      	 // $this->db->where_in('id', array(193,217,197,231,203,237,211,275,277,279,281,221,247,223,249,225,251,263,155,182,205,239,213,302,304,245,199,233,201,235,241,227,253,154,181,215,209,243));
        ...
        ?>
			...
			if($class->regular_class=='Y') { 
                ...
                $class_cbcs = array(193,194,197,198,201,202,203,204,205,206,211,212,213,214,221,222,223,224,225,226,227,228,275,276,279,280,217,231,235,237,239,245,215,247,249,251,253,277,281,209,302,303,304,305,210,267);
