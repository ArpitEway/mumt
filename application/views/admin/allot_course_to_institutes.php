...
<div class="table-responsive">
	<table class="table table-hover">
		...
		<?php
			...
			if($center)
			{
			$alloted_course = $center->alloted_course_id;
					
			$alloted_course_id = explode(",", $alloted_course);
			...
			<td><input type="checkbox" name="course_id[]" id="course_id" value="<?=$course['id'];?>"
			<?php if (in_array($course['id'], $alloted_course_id)){ ?> checked="checked" <?php } ?> ></td>
			</tr>
