	...
	<div class="table-responsive">
		<table class="table table-hover">
			...
			<tbody>
				...
				if($center){
					$alloted_course = $center->alloted_course_group_id;
					$alloted_course_group_id = explode(",", $alloted_course);
					foreach($courses as $course){
						...
						<tr>
							...
							<td><input type="checkbox" name="course_group_id[]" id="course_group_id" value="<?=$course['id'];?>"
								<?php if (in_array($course['id'], $alloted_course_group_id)){ ?> checked="checked" <?php } ?> ></td>
							</tr>
							<?php 
						}
					}
