...
<table id="mytable" class="table">
			...
			<!-- 	<td><?php echo $this->Common_model->getAdminNameById($menu["admin_id"]); ?></td> -->
				...
				<td>		
                	<div style="display: inline-flex;">
						<a href="javascript:void(0);" class="btn btn-sm btn-info" onclick="rightModal('<?php echo site_url('admin/modal/popup/admin/center/center_menu_edit_popup/'.$menu['id']); ?>', '<?php echo 'Update menu' ?>')"> <i class="text-white fas fa-pen"></i></a>  
												
						<a href="javascript:void(0);" id="delete" class="btn btn-sm btn-danger" onclick="delete_menu(<?php echo $menu['id']; ?>,this);" ?> <i class="text-white fas fa-trash"></i></a>
...
$(document).on('change', '.status_checks', function(e) {
  ...
  $("#reason").html("");
		...
		if($(this).is(":checked") == true)
		{
			...
			var url = BASE_URL + "admin/Admins/update_center_menu_status";
