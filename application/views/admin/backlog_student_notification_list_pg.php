	...
	<table width="100%"  border="1">
		...
		<tr class="alternate">
			...
			<td class="text-center" align="center" >
				<?php
				if($Withheld && $student->exam_pattern != 'GRADE'){
					// echo 'RW';
...
<?php
		...
		<?php	
			...
			if($final_result != 'FAIL'){
				...
				$gradesheetData = $this->Gradesheet_backlog_tr_model_pg->view_notification($student->student_id,$student->course_group_id,$student->class_id,$student->mode, $student->id);
					}
