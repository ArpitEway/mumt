...
<body>
<form method="post" action="<?=base_url('admin/Admins/remove_backlog_student_result_permission_previous')?>" class="mt-3" >
     ...
     <table class="table table-striped" id="kt_datatable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <input type="hidden" name ="mode" value = "<?php echo  $student->mode  ?>">
                <td><?= $i++ ?></td>
