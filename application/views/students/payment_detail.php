...
<div class="row border border-primary bg-primary text-custom p-2">
	...
	<div class="row py-3 border">
		<div class="col-sm-5 border-right">Client Transaction Id
		</div>
		<div class="col-sm-7 "><?=$transaction['clientTxnId']?>
		</div>
	</div>
	<div class="row py-3 border">
		<div class="col-sm-5 border-right">SabPaisa Transaction Id
		</div>
		<div class="col-sm-7 "><?=$transaction['SabPaisaTxId']?>
		</div>
	</div>
