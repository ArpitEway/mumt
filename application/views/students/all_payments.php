...
<table id="kt_datatable" class="table table-striped dt-responsive nowrap" width="100%" >
			...
			?>
			 <tr>
				...
				<td><?php echo $this->Common_model->getCourseNameByCourseId($payment_detail->class_id); ?></td>
			...
			<td class="text-center" >
				...
				<a target="_blank" href="<?=base_url('user/payment/detail/'.$payment_detail->id);?>"><i class="far fa-eye text-info mr-5"></i></a>
				<?php }else{
					$paymentType = ($payment_detail->fees_head=='admission') ? 'admission' : 'program_fees';
				?>
				<a target="_blank" href="<?=base_url('user/payment/'.$paymentType.'/'.$payment_detail->student_id);?>"><p class="btn btn-sm btn-success">Pay</p>
				</a>
